        ...
        <Base>
            <div className={classes.root}>
                <FormControl component="fieldset" className={classes.formControl}>
                    ...
                    <FormGroup className={classes.formGroup}>
                        <FormControlLabel
                            ...
                            label={
                                <span className="spanSelect" style={{background: "#808080"}}> <FormattedMessage
                                    id='Normal'/> </span>
                            }
                        />
                        <FormControlLabel
                            ...
                            label={
                                <span className="spanSelect" style={{background: "orange"}}> <FormattedMessage
                                    id='Fire'/> </span>
                            }
                        />
                        <FormControlLabel
                            ...
                            label={
                                <span className="spanSelect" style={{background: "#33ccff"}}> <FormattedMessage
                                    id='Water'/> </span>
                            }
                        />
                        <FormControlLabel
                            ...
                            label={
                                <span className="spanSelect" style={{background: "#00cc44"}}> <FormattedMessage
                                    id='Grass'/> </span>
                            }
                        />
                        <FormControlLabel
                            ...
                            label={
                                <span className="spanSelect" style={{background: "linear-gradient(#33ccff, #808080)"}}> <FormattedMessage
                                    id='Flying'/> </span>

                            }
                        />
                        <FormControlLabel
                            control={<Checkbox color="primary" checked={fighting} onChange={handleChange}
                                               name="fighting"/>}
                            label={
                                <span className="spanSelect" style={{background: " #cc5200"}}> <FormattedMessage
                                    id='Fighting'/> </span>
                            }
                        />
                        <FormControlLabel
                            ...
                            label={
                                <span className="spanSelect" style={{background: "#800080"}}> <FormattedMessage
                                    id='Poison'/> </span>
                            }
                        />
                        <FormControlLabel
                            control={<Checkbox color="primary" checked={electric} onChange={handleChange}
                                               name="electric"/>}
                            label={
                                <span className="spanSelect"
                                      style={{background: "#ffd11a", color: "black"}}> <FormattedMessage id='Electric'/> </span>
                            }
                        />
                        <FormControlLabel
                            control={<Checkbox color="primary" checked={ground} onChange={handleChange} name="ground"/>}
                            label={
                                <span className="spanSelect" style={{background: "linear-gradient(#ffd11a, #808080)"}}> <FormattedMessage
                                    id='Ground'/> </span>
                            }
                        />
                    </FormGroup>
                ...
                <FormControl component="fieldset" className={classes.formControl}>
                    ...
                    <FormGroup>
                        <FormControlLabel
                            ...
                            label={
                                <span className="spanSelect" style={{background: "#77773c"}}> <FormattedMessage
                                    id='Rock'/> </span>
                            }
                        />
                        <FormControlLabel
                            control={<Checkbox color="primary" checked={psychic} onChange={handleChange}
                                               name="psychic"/>}
                            label={
                                <span className="spanSelect" style={{background: "#cc0066"}}> <FormattedMessage
                                    id='Phychic'/> </span>
                            }
                        />
                        <FormControlLabel
                            ...
                            label={
                                <span className="spanSelect"
                                      style={{background: "#00ffff", color: "black"}}> <FormattedMessage
                                    id='Ice'/> </span>
                            }
                        />
                        <FormControlLabel
                            ...
                            label={
                                <span className="spanSelect" style={{background: "#408000"}}> <FormattedMessage
                                    id='Bug'/> </span>
                            }
                        />
                        <FormControlLabel
                            ...
                            label={
                                <span className="spanSelect" style={{background: "#b366ff"}}> <FormattedMessage
                                    id='Ghost'/> </span>
                            }
                        />
                        <FormControlLabel
                        ...
                        <FormControlLabel
                            ...
                            label={
                                <span className="spanSelect" style={{background: "linear-gradient(#e66465, #9198e5)"}}> <FormattedMessage
                                    id='Dragon'/> </span>
                            }
                        />
                        <FormControlLabel
                            ...
                            label={
                                <span className="spanSelect" style={{background: "#3d3d5c"}}> <FormattedMessage
                                    id='Dark'/> </span>
                            }
                        />
                        <FormControlLabel
                            ...
                            label={
                                <span className="spanSelect" style={{background: "#ff80ff"}}> <FormattedMessage
                                    id='Fairy'/> </span>
                            }
                        />
                    </FormGroup>
                ...
                <FormControl component="fieldset" className={classes.formControl}>
                    ...
                    <FormGroup>
                        <FormControlLabel
                            control={<Checkbox color="primary" checked={HeightLittle} onChange={handleChange}
                                               name="HeightLittle"/>}
                            label={
                        ...
                        />
                        <FormControlLabel
                            control={<Checkbox color="primary" checked={HeightMedium} onChange={handleChange}
                                               name="HeightMedium"/>}
                            label={
                        ...
                        />
                        <FormControlLabel
                            control={<Checkbox color="primary" checked={HeightTall} onChange={handleChange}
                                               name="HeightTall"/>}
                            label={
                ...
                <FormControl component="fieldset" className={classes.formControl}>
                    ...
                    <FormGroup>
                        <FormControlLabel
                            control={<Checkbox color="primary" checked={WeightLight} onChange={handleChange}
                                               name="WeightLight"/>}
                            label={
                        ...
                        />
                        <FormControlLabel
                            control={<Checkbox color="primary" checked={WeightMedium} onChange={handleChange}
                                               name="WeightMedium"/>}
                            label={
                        ...
                        />
                        <FormControlLabel
                            control={<Checkbox color="primary" checked={WeightHeavy} onChange={handleChange}
                                               name="WeightHeavy"/>}
                            label={
